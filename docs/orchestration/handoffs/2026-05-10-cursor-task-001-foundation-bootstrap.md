# Cursor Handoff: TaskPilot Foundation Bootstrap
...
Task Goal: Bootstrap the first working local TaskPilot application with a runnable web shell and the core dependencies needed for the MVP.
Out of Scope:
- Full workflow automation
- Multi-user auth
- Production deployment
- Deep adapter integration with Cursor/Codex/Qwen
...
- /Users/test/taskpilot/docs/orchestration/handoffs/2026-05-10-cursor-task-001-foundation-bootstrap.md
